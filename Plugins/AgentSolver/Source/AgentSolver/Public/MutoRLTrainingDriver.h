...
public:
	...
	/**
	 * Contact stiffness as a natural frequency, in Hz -- invariant to creature
	 * mass and to timestep. Measured best around 15 on the full rig; internally
	 * clamped to a quarter of the substep rate.
	 */
	UPROPERTY(EditAnywhere, Category = "Muto RL|Contact|Impulse")
	float ContactHertz = 15.0f;

	/** Contact damping ratio. 10 is a normal value for contacts (heavily damped). */
	UPROPERTY(EditAnywhere, Category = "Muto RL|Contact|Impulse")
	...
	/** Stiffness of the joint stop, in Hz. Higher than ContactHertz on purpose: a joint's end of travel is harder than the ground. */
	UPROPERTY(EditAnywhere, Category = "Muto RL|Contact|Joint Limits")
